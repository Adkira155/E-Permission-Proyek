                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select required type="text" class="form-control" id="tingkat_kelas" name="tingkat_kelas" placeholder="Jurusan">
                            <option value="{{ $class->tingkat_kelas }}" selected>{{ $class->tingkat_kelas }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select required type="text" class="form-control" id="alphabet" name="alphabet" placeholder="Jurusan">
                            <option value="{{ $class->alphabet }}">{{ $class->alphabet }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select required type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Jurusan">
                            <option value="{{ $class->jurusan }}">{{ $class->major->major }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="wali_kelas" name="wali_kelas" placeholder="ID Wali Kelas, 1, 2, 3" value="{{ $class->wali_kelas }}">
                    </div>
                    @error('wali_kelas')
                    <div class="invalid-feedback">
                      {{ $message }}
